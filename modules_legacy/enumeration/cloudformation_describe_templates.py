MODULE_METADATA = {
    'name': 'cloudformation_describe_templates',
    'display_name': 'Cloudformation Describe Templates',
    'category': 'enumeration',
    'description': 'Retrieve and return a CloudFormation template for a provided stack ARN.',
    'requires_region': False,
    'inputs': [
        { 'name': 'stack_arn', 'type': 'string', 'required': True, 'description': 'Full CloudFormation stack ARN.' },
    ],
    'output_type': 'json',
    'risk_level': 'low'
}
