MODULE_METADATA = {
    'name': 'cloudformation_enumerate_stacks',
    'display_name': 'Cloudformation Enumerate Stacks',
    'category': 'enumeration',
    'description': 'Enumerate CloudFormation stacks and statuses in selected regions.',
