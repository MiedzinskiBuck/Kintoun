MODULE_METADATA = {
    'name': 'systemsmanager_download_parameters',
    'display_name': 'Systemsmanager Download Parameters',
    'category': 'enumeration',
    'description': 'Enumerate and retrieve SSM parameter values in selected regions.',
