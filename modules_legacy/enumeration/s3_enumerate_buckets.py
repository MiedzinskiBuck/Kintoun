MODULE_METADATA = {
    ...
    'description': 'Enumerate S3 buckets and optionally list bucket objects.',
    'requires_region': False,
    'inputs': [
        { 'name': 'enumerate_objects', 'type': 'boolean', 'required': False, 'description': 'Set y/yes to list objects.' },
    ],
    'output_type': 'json',
    'risk_level': 'low'
}
