MODULE_METADATA = {
    'name': 'lambda_export_keys',
    'display_name': 'Lambda Export Keys',
    'category': 'persistence',
    'description': 'Create persistent Lambda + EventBridge exfiltration of runtime credentials.',
    'requires_region': False,
    'inputs': [
        { 'name': 'role_arn', 'type': 'string', 'required': True, 'description': 'IAM role ARN for Lambda.' },
        { 'name': 'region', 'type': 'region', 'required': True, 'description': 'Region to deploy resources.' },
        { 'name': 'server_address', 'type': 'string', 'required': True, 'description': 'Listener host for exfiltration.' },
    ],
    'output_type': 'json',
    'risk_level': 'critical'
}
