MODULE_METADATA = {
    'name': 'bruteforce_roles',
    'display_name': 'Bruteforce Roles',
    'category': 'lateral_movement',
    'description': 'Attempt STS AssumeRole against role names from a provided wordlist.',
    'requires_region': False,
    'inputs': [
        { 'name': 'wordlist_path', 'type': 'string', 'required': True, 'description': 'Path to role wordlist file.' },
        { 'name': 'account_id', 'type': 'string', 'required': True, 'description': 'Target AWS account ID.' },
        { 'name': 'session_name', 'type': 'string', 'required': False, 'description': 'Session name for AssumeRole call.' },
    ],
    'output_type': 'json',
    'risk_level': 'low'
}
