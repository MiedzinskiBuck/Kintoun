MODULE_METADATA = {
    'name': 'sqs_read_message',
    'display_name': 'Sqs Read Message',
    'category': 'exfiltration',
    'description': 'Continuously read messages from a provided SQS queue URL.',
    'requires_region': False,
    'inputs': [
        { 'name': 'queue_url', 'type': 'string', 'required': True, 'description': 'Full SQS queue URL.' },
    ],
    'output_type': 'json',
    'risk_level': 'high'
}
