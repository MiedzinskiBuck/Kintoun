MODULE_METADATA = {
    'name': 'sagemaker_notebook_abuse',
    'display_name': 'Sagemaker Notebook Abuse',
    'category': 'privilege_escalation',
    'description': 'Abuse existing SageMaker notebook by generating a pre-signed login URL.',
    ...
    'inputs': [
        ...
        { 'name': 'notebook_selection', 'type': 'string', 'required': True, 'description': 'Notebook option index.' },
    ],
    'output_type': 'json',
    'risk_level': 'critical'
}
...
def check_permissions(selected_session=None):
    ...
    if "sagemaker:ListNotebookInstances" in results_file and "sagemaker:CreatePresignedNotebookInstanceUrl" in results_file:
        return True
    else:
        return False 
